...
module.exports = async api => {
  ...
  const localESLintMajor = semver.major(semver.maxSatisfying(['4.99.0', '5.99.0', '6.99.0', '7.99.0'], localESLintRange) ||
  ...
  if (newDeps['@babel/core'] && newDeps['@babel/eslint-parser']) {
    ...
    if (localBabelCoreVersion && semver.satisfies(localBabelCoreVersion, minSupportedBabelCoreVersion)) {
