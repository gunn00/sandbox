...
module.exports = (api, options) => {
  if (options.lintOnSave) {
    ...
    const eslintPkg = loadModule('eslint/package.json', cwd, true) || loadModule('eslint/package.json', __dirname, true);
    ...
    api.chainWebpack(webpackConfig => {
      ...
      const eslintWebpackPluginOptions = {
        ...
        failOnWarning,
        failOnError,
        eslintPath: path.dirname(resolveModule('eslint/package.json', cwd) || resolveModule('eslint/package.json', __dirname)),
        formatter: 'stylish'
      };
