...
const parseDirectives = params => {
  ...
  return {
    ...
    args,
    directive: shouldResolve ? [resolveDirective(path, state, tag, directiveName), vals[0] || value, ((_a = modifiersSet[0]) === null || _a === void 0 ? void 0 : _a.size) ? args[0] || t.unaryExpression('void', t.numericLiteral(0), true) : args[0], !!((_b = modifiersSet[0]) === null || _b === void 0 ? void 0 : _b.size) && t.objectExpression([...modifiersSet[0]].map(modifier => t.objectProperty(t.identifier(modifier), t.booleanLiteral(true))))].filter(Boolean) : undefined
  };
};
const resolveDirective = (path, state, tag, directiveName) => {
  ...
  return t.callExpression((0, utils_1.createIdentifier)(state, 'resolveDirective'), [t.stringLiteral(directiveName)]);
};
