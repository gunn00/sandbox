...
module.exports = (api, options) => {
  ...
  api.chainWebpack(webpackConfig => {
    ...
    const jsRule = webpackConfig.module.rule('js').test(/\.m?jsx?$/).exclude.add(filepath => {
      ...
      if (options.transpileDependencies === true) {
        ...
        const NON_TRANSPILABLE_DEPS = ['core-js', 'webpack', 'webpack-4', 'css-loader', 'mini-css-extract-plugin', 'promise-polyfill', 'html-webpack-plugin', 'whatwg-fetch'];
